...
export default function LDMTLGF() {
  return (
    <main className="">
      <Header />
        ...
        <div className=" mr-5 max-w-full overflow-x-hidden">
          <div className="w-full">
            ...
            <div className="border-b-2 border-l-2 border-r-2 text-gray-600 pt-4 pb-5 pl-3.5 pr-3.5 ">
              <img
                src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjOY-xtWO6ci9nFW9ufouCiqMETnuSc_cvQt_xWAxgFTCAxxZz44m2_dwY18d4nzJSk77UYtUZ4o5_3iHspt27YwYtLMCwdTefhnBsSw_ja70BfZXq0mXQ6WqmmAwm6jpXTSvon-b_BllfJ5z6EkfriyDz2NEx1YTgpvXoHUv-Qb1MU7Y-93VNwMWl6/s16000/1.jpg=w1020-h680-p-k-no-nu"
                alt=""
                className="BLS-img"
              />
