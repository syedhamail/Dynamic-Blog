  ...
  return (
    <main className="relative h-full w-full bg-gradient-to-r from-blue-500 to-purple-500">
      ...
      <section className="text-black body-font">
        <div className="container mx-auto flex flex-col md:flex-row items-top justify-center px-5 py-12 md:py-20 lg:py-24">
          {/* Image Section */}
          <Link
            href={"/Components/TWITBWS"}
            className="w-full md:w-1/2 lg:max-w-lg mb-6 md:mb-0 flex justify-center"
          >
            <img
              className="object-cover object-center rounded-xl w-full h-auto"
              alt="hero"
          ...
          <div className="flex flex-col md:w-1/2 items-center md:items-start text-center md:text-left md:ml-8 lg:ml-16">
            <Link
              href={"/Components/TWITBWS"}
              className="title-font text-3xl md:text-5xl lg:text-5xl font-bold text-white mb-4 leading-tight"
            >
              <p className="HS-H-L1">
                Team Work is The Best Work Solution Of the Fast Work to Grow a Better World
              </p>
            </Link>

            <div className="flex flex-wrap items-center justify-center mt-1 md:justify-start mb-4">
              <Link
                href="/Components/TWITBWS"
                className="flex items-center mb-3 mr-5"
              >
                <FaUser className="mr-2" />
                <p className="font-semibold">Hamail Blogging</p>
              </Link>
              <span className="flex items-center mb-3">
                <MdAccessTimeFilled className="mr-2 w-4 h-4" />
                <p className="font-semibold">Dec 2, 2024</p>
              </span>
            </div>
      ...
      <section>
        {/*1st line*/}
        <div className="flex justify-center flex-col md:flex-row gap-6 px-4 sm:px-6">
          {/* 1st */}
          <div className="relative w-full sm:w-[420px] md:w-[420px] lg:w-[420px] xl:w-[420px]  overflow-hidden">
            <img
              ...
              alt="Sample Image"
              className="object-cover object-center h-96 w-full block rounded-sm opacity-80"
            />
            <div
              style={{
                position: "absolute",
            ...
            >
              <Link
                ...
                className="hover:text-indigo-300 transition-all duration-500 ease-in-out"
              >
        ...
        <div className="flex justify-center flex-col md:flex-row gap-6 px-4 sm:px-6 mt-6">
          {/*4th*/}
          <div className="relative w-full sm:w-[420px] md:w-[420px] lg:w-[420px] xl:w-[420px]  overflow-hidden">
            <img
          ...
          <div className="relative w-full sm:w-[420px] md:w-[420px] lg:w-[420px] xl:w-[420px] overflow-hidden">
            ...
            >
              <Link
                ...
                className="hover:text-indigo-300 transition:transform-0.5s ease-in-out"
              >
                Team Work is The Best Work Solution Of the Fast Work to Grow a
                Better World
              </Link>
